...
Work is tracked on the [GitHub Projects board](https://github.com/users/imrichie/projects/4). Issues are organized into milestones covering the data pipeline, retrieval, generation, evaluation, frontend, and validation.
